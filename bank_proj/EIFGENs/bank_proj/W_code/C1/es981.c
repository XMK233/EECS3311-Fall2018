...
extern void F981_7363(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F981_7364(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7365(EIF_REFERENCE);
extern EIF_TYPED_VALUE F981_7366(EIF_REFERENCE);
...
void F981_7363 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 980, Current, 0, 2, 13614);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13614);
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 5166, 0xF8000146, 0); /* case */
	tr1 = RTCCL(arg2);
	RTAR(Current, tr1);
...
void F981_7364 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 980, Current, 3, 0, 13615);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(980, Current, 13615);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	if ((EIF_BOOLEAN) !loc1) {
		...
		ur1 = tr1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4575, "item", loc2))(loc2, ur1x)).it_b);
		if (tb1) {
			RTHOOK(4);
...
EIF_TYPED_VALUE F981_7365 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 13616);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(980, Current, 13616);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F981_7366 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
