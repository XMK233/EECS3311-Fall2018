...
{
	GTCX
	RTOTC (F961_7149,13430,RTMS_EX_H("English",7,257590376));
}
...
{
	GTCX
	RTOTC (F961_7154,13435,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F961_7155,13436,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F961_7156,13437,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
...
void EIF_Minit961 (void)
{
	...
	RTOTS (7150,F961_7150)
	RTOTS (7151,F961_7151)
	RTOTS (7152,F961_7152)
	RTOTS (7153,F961_7153)
	RTOTS (7154,F961_7154)
	RTOTS (7155,F961_7155)
	RTOTS (7156,F961_7156)
}
