...
void egc_init_plug (void)
{
	...
	egc_system_name = "container";
	egc_system_location = "C:\\Users\\mathew\\Downloads\\Documents\\GitHub\\EECS3311-Fall2018\\Lab_1_v1\\container\\EIFGENs\\container\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1535424730;
	...
	egc_rlist[0] = "TEST_CONTAINERS.make";
	egc_rcdt[0] = 0;
	egc_rcrid[0] = 5073;
	egc_rcarg[0] = 0;
...
{
	if (egc_rcdt[0] == 0) {
		egc_rcdt[0] = 968; /* TEST_CONTAINERS */
	}
}
