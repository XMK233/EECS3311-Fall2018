...
EIF_TYPED_VALUE _A967_77 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5063, "test_array_ref_copy", closed [1].it_r))(closed [1].it_r);
}

	/* TEST_ARRAY_COPIES test_array_shallow_copy */
EIF_TYPED_VALUE _A967_78 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(5064, "test_array_shallow_copy", closed [1].it_r))(closed [1].it_r);
}
