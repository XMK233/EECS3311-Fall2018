...
extern EIF_TYPED_VALUE F961_7142(EIF_REFERENCE);
extern EIF_TYPED_VALUE F961_7143(EIF_REFERENCE);
extern EIF_TYPED_VALUE F961_7144(EIF_REFERENCE);
extern EIF_TYPED_VALUE F961_7145(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F961_7149(EIF_REFERENCE);
...
EIF_TYPED_VALUE F961_7142 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F961_7142,13423,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F961_7143)
EIF_TYPED_VALUE F961_7143 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13423);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(960, Current, 13423);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {277,0xFF01,231,0xFFFF};
		EIF_TYPE typres0;
...
RTOID (F961_7144)
EIF_TYPED_VALUE F961_7144 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13424);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(960, Current, 13424);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF8000110, 0,0); /* Result */
...
RTOID (F961_7145)
EIF_TYPED_VALUE F961_7145 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 960, Current, 0, 0, 13425);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
{
	GTCX
	RTOTC (F961_7147,13428,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F961_7148,13429,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F961_7149 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F961_7149,13430,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit961 (void)
{
	GTCX
	RTOTS (7142,F961_7142)
	RTOTS (7143,F961_7143)
	RTOTS (7144,F961_7144)
	RTOTS (7145,F961_7145)
	RTOTS (7146,F961_7146)
	RTOTS (7147,F961_7147)
	RTOTS (7148,F961_7148)
	RTOTS (7149,F961_7149)
}
