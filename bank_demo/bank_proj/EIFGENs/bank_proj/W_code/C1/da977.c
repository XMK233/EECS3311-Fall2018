...
extern EIF_TYPED_VALUE F977_7337(EIF_REFERENCE);
...
EIF_TYPED_VALUE F977_7337 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 976, Current, 0, 0, 13598);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(5111, "fractional_second", tr1));
